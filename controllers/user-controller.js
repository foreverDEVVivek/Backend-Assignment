...
const removeFriend =async (req,res)=>{
  ...
  try {
    ...
    userInfoUser.friends = userInfoUser.friends.filter(friend => friend.toString()!== friendId);
    userInfoFriend.friends = userInfoFriend.friends.filter(friend => friend.toString()!== userId);
...
module.exports = {removeFriend, getAllUsers, getYourDetails,addFriend };
